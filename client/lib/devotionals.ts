...
import augustData from "@/lib/devotionals-august-2026.json";
import septemberData from "@/lib/devotionals-september-2026.json";

const devotionals: Devotional[] = [
  ...(mayData as Devotional[]),
  ...(juneData as Devotional[]),
  ...(julyData as Devotional[]),
  ...(augustData as Devotional[]),
  ...(septemberData as Devotional[]),
];
