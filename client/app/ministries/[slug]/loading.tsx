          ...
          <div className="container-shell space-y-14">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="card-surface space-y-4 p-6">
                <div className="h-9 w-32 animate-pulse rounded bg-shimmer-canvas" />
                <div className="h-20 animate-pulse rounded bg-shimmer-canvas" />
              </div>
              <div className="card-surface space-y-4 p-6">
                <div className="h-9 w-44 animate-pulse rounded bg-shimmer-canvas" />
                <div className="h-20 animate-pulse rounded bg-shimmer-canvas" />
              </div>
            </div>

            <div className="space-y-5">
              <div className="h-9 w-56 animate-pulse rounded bg-shimmer-canvas" />
              <div className="card-surface h-32 animate-pulse p-6" />
            </div>

            <div className="card-surface flex flex-col gap-4 p-6 md:flex-row md:justify-between">
            ...
            <div className="space-y-6 border-t border-(--color-border-subtle) pt-10">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={`sibling-${i.toString()}`}
                    className="card-surface h-36 animate-pulse p-5"
                  />
                ))}
              </div>
            </div>
...
export default MinistrySlugLoading;
