      ...
      <section className="section-padding">
        <div className="container-shell">
          <div className="card-surface space-y-5 p-8 md:p-12">
            <p className="eyebrow">Ministries unavailable</p>
            <h1 className="text-5xl">We could not load the ministries directory.</h1>
...
export default MinistriesError;
